...
questions = {
    ...
    "transition_1": Question(
        ...
        media="",
        media_type="",
        options={translate("yalla"): "flow3_exc2_1"},
        keyboard_type="inline",
        next_question_id=""
    ),
    "flow3_exc2_1": Question(
        id="flow3_exc2_1",
        text=translate("flow3_exc2_1"),
        media="",
        media_type="",
        options={translate("ready"):"flow3_exc2_2"},
        keyboard_type="inline",
        next_question_id=""
    ),
    "flow3_exc2_2": Question(
        id="flow3_exc2_2",
        text=translate("flow3_exc2_2"),
        media="",
        media_type="",
